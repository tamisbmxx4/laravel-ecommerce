        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="cart__btn">
                        <a href="{{ route('category.index') }}">Lanjutkan Belanja</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="cart__btn update__btn">
                        <button type="submit"><span class="icon_loading"></span> Perbarui Pesanan</button>
                    </form>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-2">
                    <div class="cart__total__procced">
                        ...
                        <a href="{{ route('checkout.index') }}" class="primary-btn">Lanjutkan ke checkout</a>
                    </div>
                </div>
            </div>
        </div>
